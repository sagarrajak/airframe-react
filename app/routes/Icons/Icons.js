            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-credit-card-alt"
                                aria-hidden="true"
                            ></i>{' '}
                            credit-card-alt
                        </div>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-btc" aria-hidden="true"></i>{' '}
                            btc
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-cny" aria-hidden="true"></i>{' '}
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-euro" aria-hidden="true"></i>{' '}
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-ils" aria-hidden="true"></i>{' '}
                            ils
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-jpy" aria-hidden="true"></i>{' '}
                            jpy
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-krw" aria-hidden="true"></i>{' '}
                            krw
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-rmb" aria-hidden="true"></i>{' '}
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-ruble" aria-hidden="true"></i>{' '}
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-try" aria-hidden="true"></i>{' '}
                            try
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-won" aria-hidden="true"></i>{' '}
                            won <span class="text-muted">(alias)</span>
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-yen" aria-hidden="true"></i>{' '}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-cut" aria-hidden="true"></i>{' '}
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-paste" aria-hidden="true"></i>{' '}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-pause-circle"
                                aria-hidden="true"
                            ></i>{' '}
                            pause-circle
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-pause-circle-o"
                                aria-hidden="true"
                            ></i>{' '}
                            pause-circle-o
                        </div>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row class="fontawesome-icon-list margin-bottom-lg">
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-500px" aria-hidden="true"></i>{' '}
                            500px
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-adn" aria-hidden="true"></i>{' '}
                            adn
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-css3" aria-hidden="true"></i>{' '}
                            css3
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-digg" aria-hidden="true"></i>{' '}
                            digg
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-edge" aria-hidden="true"></i>{' '}
                            edge
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-font-awesome"
                                aria-hidden="true"
                            ></i>{' '}
                            font-awesome
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-fort-awesome"
                                aria-hidden="true"
                            ></i>{' '}
                            fort-awesome
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-git" aria-hidden="true"></i>{' '}
                            git
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-glide" aria-hidden="true"></i>{' '}
                            glide
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-glide-g"
                                aria-hidden="true"
                            ></i>{' '}
                            glide-g
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-google-plus-circle"
                                aria-hidden="true"
                            ></i>{' '}
                            google-plus-circle{' '}
                            <span class="text-muted">(alias)</span>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-houzz" aria-hidden="true"></i>{' '}
                            houzz
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-html5" aria-hidden="true"></i>{' '}
                            html5
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-mixcloud"
                                aria-hidden="true"
                            ></i>{' '}
                            mixcloud
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-modx" aria-hidden="true"></i>{' '}
                            modx
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-opera" aria-hidden="true"></i>{' '}
                            opera
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-pied-piper-pp"
                                aria-hidden="true"
                            ></i>{' '}
                            pied-piper-pp
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-rebel" aria-hidden="true"></i>{' '}
                            rebel
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-reddit-alien"
                                aria-hidden="true"
                            ></i>{' '}
                            reddit-alien
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-slack" aria-hidden="true"></i>{' '}
                            slack
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-snapchat-ghost"
                                aria-hidden="true"
                            ></i>{' '}
                            snapchat-ghost
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-snapchat-square"
                                aria-hidden="true"
                            ></i>{' '}
                            snapchat-square
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-steam" aria-hidden="true"></i>{' '}
                            steam
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-usb" aria-hidden="true"></i>{' '}
                            usb
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-viadeo-square"
                                aria-hidden="true"
                            ></i>{' '}
                            viadeo-square
                        </div>
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-yahoo" aria-hidden="true"></i>{' '}
                            yahoo
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-yelp" aria-hidden="true"></i>{' '}
                            yelp
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i class="fa fa-fw fa-yoast" aria-hidden="true"></i>{' '}
                            yoast
                        </div>
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4">
                            <i
                                class="fa fa-fw fa-wheelchair-alt"
                                aria-hidden="true"
                            ></i>{' '}
                            wheelchair-alt
                        </div>
